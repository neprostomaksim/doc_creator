...
export function CaseDetail({
  ...
  return (
    <div>
      ...
      <p className="mb-4 text-sm text-gray-500">Клиент: {clientName}</p>
      ...
      <h2 className="mb-3 text-sm font-medium text-gray-700">Версии</h2>
      <div className="space-y-2">
        {versions.map((v) => (
          ...
          >
            <div>
              <p className="font-medium text-gray-900">v{v.versionNumber}</p>
